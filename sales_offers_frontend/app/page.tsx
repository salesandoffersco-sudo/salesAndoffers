  ...
  return (
    <div className="min-h-screen bg-[rgb(var(--color-bg))] relative overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute inset-0 bg-white/10 dark:bg-black/10" style={{ backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)' }}></div>
      </div>
      ...
      <div className="relative z-10">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-[rgb(var(--color-muted))] mb-8 max-w-4xl mx-auto leading-relaxed">
              Find the best deals across Kenya with premier sales and offer platform
            </p>
            ...
            <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-[rgb(var(--color-muted))] mt-1">Sellers</div>
              </div>
              <div className="text-center">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-[rgb(var(--color-muted))] max-w-3xl mx-auto">
              listed deals from top rated sellers with the best prices across the market. don't miss any opportunity to save.
            </p>
          </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 bg-[rgb(var(--color-ui))]">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-[rgb(var(--color-muted))] max-w-3xl mx-auto">
              discover sellers with most sales and offers
            </p>
          </div>
          ...
          <div className="relative bg-gradient-to-br from-purple-600 via-blue-600 to-purple-700 rounded-3xl p-12 text-center text-white shadow-2xl overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl md:text-2xl mb-8 opacity-90 max-w-3xl mx-auto leading-relaxed">
                Join Kenya's smartest shoppers and start finding deals across multiple stores to save money on every purchase.
              </p>
