...
<div className="fixed top-0 right-0 h-full w-80 bg-white dark:bg-gray-800 shadow-xl z-[9999] transform translate-x-0 transition-transform duration-300 md:hidden isolate border-l border-gray-200 dark:border-gray-700" style={{position: 'fixed', top: 0, right: 0, height: '100vh', zIndex: 9999}}>
            <div className="p-6">
