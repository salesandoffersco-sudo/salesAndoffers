...
<div className="fixed top-0 right-0 h-full w-80 bg-[rgb(var(--color-card))] shadow-xl z-[70] transform translate-x-0 transition-transform duration-300 md:hidden isolate">
            <div className="p-6">
